...
insert into Recording (id, version, title, price, rtype) values(-301, 1, 'Greatest Hits', 9.67, 'M')
insert into MusicRecordings (id, artist_name) values (-301, 'The Java Junquies')

insert into Duration (id, totalseconds, hours, minutes, seconds) values(-1234, 360, 0, 10, 0);
insert into Tracks (id, title, duration_id, product_id, index_number) values(-1, 'All Hits Medley', -1234, -301, 0)
...
-- Customers
insert into Person(id, version, firstName, lastName, ptype) values(-150, 1, 'A', 'Byer', 'C')
insert into Customer(id, salesrep_id) values (-150, -200)
insert into Person(id, version, firstName, lastName, ptype) values(-151, 1, 'Top', 'Shopper', 'C')
